...
const pt = {
  ...
  models: {
    ...
    batch: 'Batch',
    batchDescription: 'Configure o roteamento de modelos batch e a consulta de resultados.',
    batchPollInterval: 'Intervalo de consulta',
    batchPollIntervalDescription: 'Consulte os resultados batch neste intervalo.',
    batchModelRegex: 'Regex de modelo batch',
    batchModelRegexDescription:
      'IDs de modelo compatíveis com OpenAI que correspondam a esta expressão sem diferenciação entre maiúsculas e minúsculas usam a Batch API.',
    seconds: 'segundos',
  ...
  chat: {
    ...
    pastedTextAttached: 'Texto longo anexado como arquivo · {{characters}} caracteres',
    pastedTextTruncated: 'Apenas os primeiros {{characters}} caracteres foram anexados.',
    longTextCollapsed: 'Mensagem longa · {{characters}} caracteres',
    showFullText: 'Mostrar texto completo',
    hideFullText: 'Recolher',
    ...
    webSearchDescriptions: {
      ...
      duckduckgo: 'Pesquisar fontes atuais com o DuckDuckGo.',
    },
    useWebSearchFallback: 'Usar mecanismos de reserva',
