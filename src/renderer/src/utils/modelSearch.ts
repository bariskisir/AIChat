/**
 * Fuzzy model search with ranked matching, ported from upstream modelSearch.ts.
 * Supports raw substring, normalized substring, token-initial, and abbreviation
 * matches, each weighted so better matches rank first.
 */
