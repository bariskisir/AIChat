...
export function populateModelOptions(refs: Refs, state: AppSnapshot | null): void {
  if (!state) {
...
export function selectModel(refs: Refs, value: string): void {
...
function renderCodexControls(refs: Refs, state: AppSnapshot): void {
...
function renderModelDropdownLabel(refs: Refs, options: Array<{ value: string; label: string }>): void {
...
function selectedCatalogModel(refs: Refs, state: AppSnapshot): AvailableModel | undefined {
...
function selectedProvider(refs: Refs, state: AppSnapshot): ProviderConfig | undefined {
