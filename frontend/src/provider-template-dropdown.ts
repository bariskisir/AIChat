...
export function bind(refs: Refs, onSelected: () => void): void {
...
export function populate(refs: Refs): void {
...
export function resetSearch(refs: Refs): void {
  refs.providerTemplateSearchInput.value = "";
}

// Updates the provider template button label.
export function renderLabel(refs: Refs): void {
...
export function close(refs: Refs): void {
...
function selectValue(refs: Refs, value: string, onSelected: () => void): void {
...
function renderOptions(refs: Refs): void {
...
function optionNode(refs: Refs, template: ProviderTemplates.Template): HTMLButtonElement {
