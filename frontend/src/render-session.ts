...
export function renderSessions(refs: Refs, state: AppSnapshot): void {
...
export function renderSessionTitle(refs: Refs, model: UiModel, sessionId: string, title: string): void {
