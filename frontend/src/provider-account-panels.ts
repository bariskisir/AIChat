...
namespace ProviderAccountPanels {
  ...
  export function bind(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): void {
  ...
  export function isSpecialForm(refs: DomRefs.Refs): boolean {
  ...
  export function applyTemplate(refs: DomRefs.Refs, template: ProviderTemplates.Template): void {
  ...
  export function render(refs: DomRefs.Refs): void {
  ...
  function isCodexForm(refs: DomRefs.Refs): boolean {
  ...
  function isClaudeForm(refs: DomRefs.Refs): boolean {
  ...
  function syncSpecialProviderId(refs: DomRefs.Refs): void {
  ...
  function renderCodexAccount(refs: DomRefs.Refs, isCodex: boolean): void {
  ...
  function renderClaudeAccount(refs: DomRefs.Refs, isClaude: boolean): void {
    const state = AppContext.model.appState;
  ...
  async function startCodexLogin(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  async function signOutCodex(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  async function startClaudeLogin(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  async function signOutClaude(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  async function refreshCodexAccount(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  async function refreshClaudeAccount(refs: DomRefs.Refs, setStatus: (message: string, isError?: boolean) => void): Promise<void> {
  ...
  function renderSnapshot(refs: DomRefs.Refs, snapshot: AppSnapshot): void {
