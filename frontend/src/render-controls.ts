...
namespace Renderer {
  ...
  export function renderStatus(refs: DomRefs.Refs, message: string, isError: boolean = false): void {
  ...
  export function populateOptions(refs: DomRefs.Refs, state: AppSnapshot): void {
